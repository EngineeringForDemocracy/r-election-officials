...
Example of a simple <span class="glosario_def">[time series](https://glosario.carpentries.org/en/#time_series)</span> plot in base R showing 
...
In these cases, <span class="glosario_def">[histograms](https://glosario.carpentries.org/en/#histogram)</span> are more appropriate to use! 
