...
```{r barplot-wall-types-labeled2, fig.alt="Previous plot with plot title and labels added."}
hourly_counts %>%
  mutate(avg_color = ifelse(n > average, "Above", "Below")) %>%
  ggplot(aes(x = hour, y = n)) +
  geom_line() +
